...
public class MainActivity extends AppCompatActivity {
    ...
    private String stringAPIKey = System.getenv("OPENAI_API_KEY");
    ...
    private void chatGPTModel(String stringInput){
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST,
            ...
            public void onErrorResponse(VolleyError error) {
                // Виводимо в лог деталі про помилку
                if (error.networkResponse != null) {
                    ...
                    textView.setText("Error: " + (error.getMessage() != null ? error.getMessage() : "Unknown error"));
                }

                error.printStackTrace(); // Для перегляду повного стектрейсу у логах
            }
        }){
            @Override
